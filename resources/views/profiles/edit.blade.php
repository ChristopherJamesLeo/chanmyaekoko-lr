                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12  mb-2">
                                <div class="form-group">
                                    <input type="text" name="name" id="" class="form-control form-control-md shadow-none outline-none" placeholder="Full Name" required value="{{$profile -> name}}" >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 mb-2">
                                <div class="form-group">
                                    <input type="text" name="firstname" id="" class="form-control form-control-md shadow-none outline-none" placeholder="First Name" required  value="{{$profile -> firstname}}" >
                                </div>
                            </div>
                            <div class="col-lg-12 mb-2">
                                <div class="form-group">
