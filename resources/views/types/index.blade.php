                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <div class="form-group">
                                    <input type="text" name="name" id="service_type" class="form-control form-control-md shadow-none outline-none" placeholder="Type" required >
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <td>
                                    <div class="d-flex justify-content-end gap-2">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm secondary rounded-0 delete-btns" 
                                            data-id="{{$type->id}}" 
                                            data-name="{{$type->name}}" ><i class="fas fa-trash "
                                            ></i>
                                        </a>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".edit_form_btn").click(function(){
                ...
                $("#edit_form_container").attr("action",`/types/${getId}`);
            })
        })
    </script>
@endsection
